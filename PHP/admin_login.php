...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($email) && !empty($password)) {
        ...
        if ($stmt = $conn->prepare($query)) {
            ...
            if ($user = $result->fetch_assoc()) {
                if (password_verify($password, $user['password'])) {
                    ...
                    if (isset($_POST['remember_me'])) {
                        ...
                        if ($updateStmt = $conn->prepare($updateTokenQuery)) {
            ...
            $error = "Erreur de préparation : " . $conn->error;
        }
        $conn->close();
    } else {
		...
		<div class="screen__content">
			<form action="admin_login.php" method="post" class="login">
				<div class="login__field">
					...
					<input type="text" id="email" name="email" class="login__input" placeholder="Email">
				</div>
				<div class="login__field">
					<i class="login__icon fas fa-lock"></i>
					<input type="password" id="password" name="password" class="login__input" placeholder="Mot de passe">
				</div>
